package com.example.footballteamapi.common.infrastructure.config;
...
class OpenApiConfigTest {
    ...
    void openApiInfo() {
        ...
        assertEquals("footballteamapi", openAPIDefinition.info().title());
        assertEquals("Case Study - Football Team Api" +
    ...
    void contactInfo() {
        ...
        assertEquals("https://github.com/Rapter1990/footballteamapi", contact.url());
